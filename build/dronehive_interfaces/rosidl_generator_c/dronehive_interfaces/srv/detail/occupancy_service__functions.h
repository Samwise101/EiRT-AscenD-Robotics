...
#ifndef DRONEHIVE_INTERFACES__SRV__DETAIL__OCCUPANCY_SERVICE__FUNCTIONS_H_
#define DRONEHIVE_INTERFACES__SRV__DETAIL__OCCUPANCY_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/OccupancyService message.
/**
...
/// Finalize srv/OccupancyService message.
/**
...
/// Create srv/OccupancyService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dronehive_interfaces__srv__OccupancyService_Request__init().
...
/// Destroy srv/OccupancyService message.
/**
 * It calls
 * dronehive_interfaces__srv__OccupancyService_Request__fini()
...
/// Check for srv/OccupancyService message equality.
/**
...
/// Copy a srv/OccupancyService message.
/**
...
/// Initialize array of srv/OccupancyService messages.
/**
...
/// Finalize array of srv/OccupancyService messages.
/**
 * It calls
 * dronehive_interfaces__srv__OccupancyService_Request__fini()
...
/// Create array of srv/OccupancyService messages.
/**
 * It allocates the memory for the array and calls
 * dronehive_interfaces__srv__OccupancyService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OccupancyService messages.
/**
 * It calls
 * dronehive_interfaces__srv__OccupancyService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OccupancyService message array equality.
/**
...
/// Copy an array of srv/OccupancyService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dronehive_interfaces__srv__OccupancyService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dronehive_interfaces
...
/**
 * It calls
 * dronehive_interfaces__srv__OccupancyService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dronehive_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dronehive_interfaces__srv__OccupancyService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dronehive_interfaces
...
/**
 * It calls
 * dronehive_interfaces__srv__OccupancyService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRONEHIVE_INTERFACES__SRV__DETAIL__OCCUPANCY_SERVICE__FUNCTIONS_H_
