...
dronehive_interfaces__msg__ToggleTrajectory__init(dronehive_interfaces__msg__ToggleTrajectory * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->drone_id)) {
    dronehive_interfaces__msg__ToggleTrajectory__fini(msg);
    return false;
  }
  // toggle
  return true;
...
dronehive_interfaces__msg__ToggleTrajectory__create()
{
  ...
  dronehive_interfaces__msg__ToggleTrajectory * msg = (dronehive_interfaces__msg__ToggleTrajectory *)allocator.allocate(sizeof(dronehive_interfaces__msg__ToggleTrajectory), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dronehive_interfaces__msg__ToggleTrajectory));
  bool success = dronehive_interfaces__msg__ToggleTrajectory__init(msg);
  if (!success) {
...
dronehive_interfaces__msg__ToggleTrajectory__Sequence__init(dronehive_interfaces__msg__ToggleTrajectory__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__msg__ToggleTrajectory * data = NULL;

  if (size) {
    data = (dronehive_interfaces__msg__ToggleTrajectory *)allocator.zero_allocate(size, sizeof(dronehive_interfaces__msg__ToggleTrajectory), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dronehive_interfaces__msg__ToggleTrajectory__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dronehive_interfaces__msg__ToggleTrajectory__fini(&data[i - 1]);
      }
...
dronehive_interfaces__msg__ToggleTrajectory__Sequence__fini(dronehive_interfaces__msg__ToggleTrajectory__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dronehive_interfaces__msg__ToggleTrajectory__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__msg__ToggleTrajectory__Sequence * array = (dronehive_interfaces__msg__ToggleTrajectory__Sequence *)allocator.allocate(sizeof(dronehive_interfaces__msg__ToggleTrajectory__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dronehive_interfaces__msg__ToggleTrajectory__Sequence__init(array, size);
  if (!success) {
...
dronehive_interfaces__msg__ToggleTrajectory__Sequence__destroy(dronehive_interfaces__msg__ToggleTrajectory__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dronehive_interfaces__msg__ToggleTrajectory__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dronehive_interfaces__msg__ToggleTrajectory__Sequence__are_equal(const dronehive_interfaces__msg__ToggleTrajectory__Sequence * lhs, const dronehive_interfaces__msg__ToggleTrajectory__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dronehive_interfaces__msg__ToggleTrajectory__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dronehive_interfaces__msg__ToggleTrajectory__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dronehive_interfaces__msg__ToggleTrajectory);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dronehive_interfaces__msg__ToggleTrajectory * data =
      (dronehive_interfaces__msg__ToggleTrajectory *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dronehive_interfaces__msg__ToggleTrajectory__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dronehive_interfaces__msg__ToggleTrajectory__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dronehive_interfaces__msg__ToggleTrajectory__copy(
