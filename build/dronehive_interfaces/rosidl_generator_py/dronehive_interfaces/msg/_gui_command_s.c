...
bool dronehive_interfaces__msg__gui_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._gui_command.GuiCommand", full_classname_dest, 48) == 0);
  }
  dronehive_interfaces__msg__GuiCommand * ros_message = _ros_message;
  {  // command
...
PyObject * dronehive_interfaces__msg__gui_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._gui_command");
