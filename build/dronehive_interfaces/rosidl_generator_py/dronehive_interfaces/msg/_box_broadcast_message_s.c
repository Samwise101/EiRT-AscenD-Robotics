...
bool dronehive_interfaces__msg__box_broadcast_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._box_broadcast_message.BoxBroadcastMessage", full_classname_dest, 67) == 0);
  }
  dronehive_interfaces__msg__BoxBroadcastMessage * ros_message = _ros_message;
  {  // box_id
...
{
  /* NOTE(esteve): Call constructor of BoxBroadcastMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._box_broadcast_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxBroadcastMessage");
