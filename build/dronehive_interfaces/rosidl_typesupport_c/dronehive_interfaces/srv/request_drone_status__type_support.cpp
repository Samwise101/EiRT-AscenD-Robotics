...
static const _RequestDroneStatus_Request_type_support_symbol_names_t _RequestDroneStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, RequestDroneStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, RequestDroneStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, RequestDroneStatus_Request)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::RequestDroneStatus_Request_message_type_support_handle;
}
...
static const _RequestDroneStatus_Response_type_support_symbol_names_t _RequestDroneStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, RequestDroneStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, RequestDroneStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, RequestDroneStatus_Response)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::RequestDroneStatus_Response_message_type_support_handle;
}
...
static const _RequestDroneStatus_type_support_symbol_names_t _RequestDroneStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, RequestDroneStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, RequestDroneStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, RequestDroneStatus)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::RequestDroneStatus_service_type_support_handle;
}
