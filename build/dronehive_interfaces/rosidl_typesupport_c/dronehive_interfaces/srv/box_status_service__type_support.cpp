...
static const _BoxStatusService_Request_type_support_symbol_names_t _BoxStatusService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, BoxStatusService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, BoxStatusService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, BoxStatusService_Request)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::BoxStatusService_Request_message_type_support_handle;
}
...
static const _BoxStatusService_Response_type_support_symbol_names_t _BoxStatusService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, BoxStatusService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, BoxStatusService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, BoxStatusService_Response)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::BoxStatusService_Response_message_type_support_handle;
}
...
static const _BoxStatusService_type_support_symbol_names_t _BoxStatusService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, srv, BoxStatusService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, srv, BoxStatusService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, srv, BoxStatusService)() {
  return &::dronehive_interfaces::srv::rosidl_typesupport_c::BoxStatusService_service_type_support_handle;
}
