...
static const _SetPathMessage_type_support_symbol_names_t _SetPathMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, msg, SetPathMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, msg, SetPathMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, msg, SetPathMessage)() {
  return &::dronehive_interfaces::msg::rosidl_typesupport_c::SetPathMessage_message_type_support_handle;
}
