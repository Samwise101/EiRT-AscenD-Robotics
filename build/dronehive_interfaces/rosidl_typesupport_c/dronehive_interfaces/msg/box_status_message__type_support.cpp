...
static const _BoxStatusMessage_type_support_symbol_names_t _BoxStatusMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, msg, BoxStatusMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dronehive_interfaces, msg, BoxStatusMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dronehive_interfaces, msg, BoxStatusMessage)() {
  return &::dronehive_interfaces::msg::rosidl_typesupport_c::BoxStatusMessage_message_type_support_handle;
}
