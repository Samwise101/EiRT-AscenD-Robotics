...
bool dronehive_interfaces__msg__box_status_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._box_status_message.BoxStatusMessage", full_classname_dest, 61) == 0);
  }
  dronehive_interfaces__msg__BoxStatusMessage * ros_message = _ros_message;
  {  // landing_pos
  ...
  {  // box_battery_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "box_battery_level");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->box_battery_level = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // box_id
...
{
  /* NOTE(esteve): Call constructor of BoxStatusMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._box_status_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxStatusMessage");
  ...
  {  // box_battery_level
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->box_battery_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "box_battery_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
