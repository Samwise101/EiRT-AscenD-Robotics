...
bool dronehive_interfaces__msg__drone_force_landing_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._drone_force_landing_message.DroneForceLandingMessage", full_classname_dest, 78) == 0);
  }
  dronehive_interfaces__msg__DroneForceLandingMessage * ros_message = _ros_message;
  {  // landing_pos
...
{
  /* NOTE(esteve): Call constructor of DroneForceLandingMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._drone_force_landing_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DroneForceLandingMessage");
