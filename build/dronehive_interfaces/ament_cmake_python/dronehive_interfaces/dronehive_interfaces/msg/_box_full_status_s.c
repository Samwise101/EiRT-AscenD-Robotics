...
bool dronehive_interfaces__msg__box_full_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._box_full_status.BoxFullStatus", full_classname_dest, 55) == 0);
  }
  dronehive_interfaces__msg__BoxFullStatus * ros_message = _ros_message;
  {  // box_id
  ...
  {  // box_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "box_status");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->box_status, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // drone_id
...
{
  /* NOTE(esteve): Call constructor of BoxFullStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._box_full_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxFullStatus");
  ...
  {  // box_status
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->box_status.data,
      strlen(ros_message->box_status.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "box_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
