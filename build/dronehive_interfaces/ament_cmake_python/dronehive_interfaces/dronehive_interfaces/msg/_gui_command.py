...
class Metaclass_GuiCommand(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'SEARCH_FOR_NEW_DRONE': cls.__constants['SEARCH_FOR_NEW_DRONE'],
        }
    ...
    @property
    def SEARCH_FOR_NEW_DRONE(self):
        """Message constant 'SEARCH_FOR_NEW_DRONE'."""
        return Metaclass_GuiCommand.__constants['SEARCH_FOR_NEW_DRONE']
