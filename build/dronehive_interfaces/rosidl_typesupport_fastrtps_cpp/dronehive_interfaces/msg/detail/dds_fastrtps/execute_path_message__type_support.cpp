...
#include "dronehive_interfaces/msg/detail/execute_path_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dronehive_interfaces::msg::ExecutePathMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.execution_type;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dronehive_interfaces::msg::ExecutePathMessage & ros_message)
{
  // Member: box_id
  cdr >> ros_message.box_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dronehive_interfaces
max_serialized_size_ExecutePathMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dronehive_interfaces::msg::ExecutePathMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dronehive_interfaces::msg::ExecutePathMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dronehive_interfaces::msg::ExecutePathMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ExecutePathMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dronehive_interfaces::msg::ExecutePathMessage *>(
...
static size_t _ExecutePathMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ExecutePathMessage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ExecutePathMessage__callbacks = {
...
static rosidl_message_type_support_t _ExecutePathMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExecutePathMessage__callbacks,
...
{
  return &dronehive_interfaces::msg::typesupport_fastrtps_cpp::_ExecutePathMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dronehive_interfaces, msg, ExecutePathMessage)() {
  return &dronehive_interfaces::msg::typesupport_fastrtps_cpp::_ExecutePathMessage__handle;
}
