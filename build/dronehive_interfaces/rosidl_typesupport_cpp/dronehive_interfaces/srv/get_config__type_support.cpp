...
static const _GetConfig_Request_type_support_symbol_names_t _GetConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dronehive_interfaces, srv, GetConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dronehive_interfaces, srv, GetConfig_Request)),
  }
};
...
get_message_type_support_handle<dronehive_interfaces::srv::GetConfig_Request>()
{
  return &::dronehive_interfaces::srv::rosidl_typesupport_cpp::GetConfig_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dronehive_interfaces, srv, GetConfig_Request)() {
  return get_message_type_support_handle<dronehive_interfaces::srv::GetConfig_Request>();
}
...
static const _GetConfig_Response_type_support_symbol_names_t _GetConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dronehive_interfaces, srv, GetConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dronehive_interfaces, srv, GetConfig_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dronehive_interfaces::srv::GetConfig_Response>()
{
  return &::dronehive_interfaces::srv::rosidl_typesupport_cpp::GetConfig_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dronehive_interfaces, srv, GetConfig_Response)() {
  return get_message_type_support_handle<dronehive_interfaces::srv::GetConfig_Response>();
}
...
static const _GetConfig_type_support_symbol_names_t _GetConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dronehive_interfaces, srv, GetConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dronehive_interfaces, srv, GetConfig)),
  }
};
...
get_service_type_support_handle<dronehive_interfaces::srv::GetConfig>()
{
  return &::dronehive_interfaces::srv::rosidl_typesupport_cpp::GetConfig_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dronehive_interfaces, srv, GetConfig)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dronehive_interfaces::srv::GetConfig>();
}
