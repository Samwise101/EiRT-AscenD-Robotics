...
#include "dronehive_interfaces/msg/detail/position_message__rosidl_typesupport_fastrtps_c.h"
...
using _PositionMessage__ros_msg_type = dronehive_interfaces__msg__PositionMessage;
...
static uint32_t _PositionMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dronehive_interfaces__msg__PositionMessage(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dronehive_interfaces__msg__PositionMessage;
    is_plain =
      (
...
static size_t _PositionMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dronehive_interfaces__msg__PositionMessage(
