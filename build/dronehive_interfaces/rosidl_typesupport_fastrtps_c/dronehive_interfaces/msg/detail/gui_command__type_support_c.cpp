...
#include "dronehive_interfaces/msg/detail/gui_command__rosidl_typesupport_fastrtps_c.h"
...
using _GuiCommand__ros_msg_type = dronehive_interfaces__msg__GuiCommand;
  ...
  void * untyped_ros_message)
{
  ...
  _GuiCommand__ros_msg_type * ros_message = static_cast<_GuiCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: command
  {
    cdr >> ros_message->command;
  }
...
size_t get_serialized_size_dronehive_interfaces__msg__GuiCommand(
  const void * untyped_ros_message,
...
static uint32_t _GuiCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dronehive_interfaces__msg__GuiCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dronehive_interfaces
size_t max_serialized_size_dronehive_interfaces__msg__GuiCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dronehive_interfaces__msg__GuiCommand;
    is_plain =
      (
...
static size_t _GuiCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dronehive_interfaces__msg__GuiCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, msg, GuiCommand)() {
