...
#include "dronehive_interfaces/msg/detail/set_path_message__rosidl_typesupport_fastrtps_c.h"
...
using _SetPathMessage__ros_msg_type = dronehive_interfaces__msg__SetPathMessage;

static bool _SetPathMessage__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetPathMessage__ros_msg_type * ros_message = static_cast<const _SetPathMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: box_id
  {
...
static bool _SetPathMessage__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _SetPathMessage__ros_msg_type * ros_message = static_cast<_SetPathMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: box_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_dronehive_interfaces__msg__SetPathMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPathMessage__ros_msg_type * ros_message = static_cast<const _SetPathMessage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPathMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dronehive_interfaces__msg__SetPathMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dronehive_interfaces
size_t max_serialized_size_dronehive_interfaces__msg__SetPathMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dronehive_interfaces__msg__SetPathMessage;
    is_plain =
      (
...
static size_t _SetPathMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_dronehive_interfaces__msg__SetPathMessage(
...
static message_type_support_callbacks_t __callbacks_SetPathMessage = {
  "dronehive_interfaces::msg",
  "SetPathMessage",
  _SetPathMessage__cdr_serialize,
  _SetPathMessage__cdr_deserialize,
  _SetPathMessage__get_serialized_size,
  _SetPathMessage__max_serialized_size
};

static rosidl_message_type_support_t _SetPathMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetPathMessage,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dronehive_interfaces, msg, SetPathMessage)() {
  return &_SetPathMessage__type_support;
}
