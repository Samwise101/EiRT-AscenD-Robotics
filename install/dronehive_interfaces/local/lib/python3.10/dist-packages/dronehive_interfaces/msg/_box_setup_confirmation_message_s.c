...
bool dronehive_interfaces__msg__box_setup_confirmation_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._box_setup_confirmation_message.BoxSetupConfirmationMessage", full_classname_dest, 84) == 0);
  }
  dronehive_interfaces__msg__BoxSetupConfirmationMessage * ros_message = _ros_message;
  {  // confirm
...
{
  /* NOTE(esteve): Call constructor of BoxSetupConfirmationMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._box_setup_confirmation_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxSetupConfirmationMessage");
