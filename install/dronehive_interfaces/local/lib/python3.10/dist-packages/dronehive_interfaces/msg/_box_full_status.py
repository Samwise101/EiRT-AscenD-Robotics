...
class Metaclass_BoxFullStatus(type):
    """Metaclass of message 'BoxFullStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__box_full_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__box_full_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__box_full_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__box_full_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__box_full_status
...
class BoxFullStatus(metaclass=Metaclass_BoxFullStatus):
    """Message class 'BoxFullStatus'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.box_status = kwargs.get('box_status', str())
    ...
    def __eq__(self, other):
        ...
        if self.box_id != other.box_id:
            return False
        if self.box_status != other.box_status:
            return False
    ...
    def box_status(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'box_status' field must be of type 'str'"
