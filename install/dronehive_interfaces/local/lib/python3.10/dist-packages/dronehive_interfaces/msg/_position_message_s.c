...
bool dronehive_interfaces__msg__position_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dronehive_interfaces.msg._position_message.PositionMessage", full_classname_dest, 58) == 0);
  }
  dronehive_interfaces__msg__PositionMessage * ros_message = _ros_message;
  {  // lat
  ...
  {  // elv
    PyObject * field = PyObject_GetAttrString(_pymsg, "elv");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->elv = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * dronehive_interfaces__msg__position_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dronehive_interfaces.msg._position_message");
  ...
  {  // elv
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->elv);
    {
      int rc = PyObject_SetAttrString(_pymessage, "elv", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
