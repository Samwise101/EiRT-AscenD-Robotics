...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__init(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->drone_id)) {
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__fini(msg);
    return false;
  }
  // waypoints
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__create()
{
  ...
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request * msg = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request *)allocator.allocate(sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request));
  bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__init(msg);
  if (!success) {
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__init(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request * data = NULL;

  if (size) {
    data = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request *)allocator.zero_allocate(size, sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__fini(&data[i - 1]);
      }
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__fini(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * array = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence *)allocator.allocate(sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__init(array, size);
  if (!success) {
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__destroy(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence__are_equal(const dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * lhs, const dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request * data =
      (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response * msg = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response *)allocator.allocate(sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response));
  bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__destroy(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__init(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response * data = NULL;

  if (size) {
    data = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response *)allocator.zero_allocate(size, sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__fini(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * array = (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence *)allocator.allocate(sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__destroy(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence__are_equal(const dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * lhs, const dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response * data =
      (dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dronehive_interfaces__srv__DroneTrajectoryWaypointsService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
