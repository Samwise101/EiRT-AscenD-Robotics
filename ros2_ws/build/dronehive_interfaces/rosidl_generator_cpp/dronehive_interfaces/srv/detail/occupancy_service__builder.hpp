...
class Init_OccupancyService_Response_status
{
public:
  Init_OccupancyService_Response_status()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::dronehive_interfaces::srv::OccupancyService_Response status(::dronehive_interfaces::srv::OccupancyService_Response::_status_type arg)
  {
...
{
  return dronehive_interfaces::srv::builder::Init_OccupancyService_Response_status();
}
